...
loadstring(game:HttpGet("https://raw.githubusercontent.com/NHMdz/BloxFruit/refs/heads/main/Noti.lua "))()
...
NotificationLibrary:SendNotification("Warning", "Nếu script bị lỗi hay vô link sv ở phần đều để được sp", 10)
-- join team
...
local Tabs = {
    ...
    af = Window:AddTab({ Title = "Another Farm", Icon = "" }),
...
getgenv().ToTargets = function(p)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.Auto_Bone or _G.AutoKata or _G.AutoLevel or _G.AutoBoss or _G.Farmfast or _G.Tweenfruit or _G.Auto_Dungeon or _G.Kill_V4 or _G.AutoQuestRace or _G.RaDaoKhi or _G.Luom_Gear or _G.DaoBiLon or _G.BayDao or _G.Eli_Ngu or _G.Chuate_Bac_Giang or _G.AutoCarvender or _G.Di_nghia_vu_quan_su or _G.AutoEctoplasm or _G.Kiem_Lua or Auto_Ki_Di or _G.Khi_Dot_Len_Dien or _G.AutoPole or _G.AutoMaterial or _G.Quest_Nhu_Cai_Lon or _G.Katakuri_V2_Nhu_lon or _G.Auto_Nha_Dien or _G.Cuttay or _G.Thang_Cha_Up_Muon or Gan_Haki_Lon or _G.HaiCac or _G.Shanda or BatDauKaitun or _TerroSharkVaPirranhaOMG or _G.Zone6 or _G.TeleportPly or _G.RaidPirate or _G.autoLawRaid or StartFarm or FarmMasGun or _G.Chest or _G.Buoi == true then
    ...
    spawn(function()
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.Auto_Bone or _G.AutoKata or _G.AutoLevel or _G.AutoBoss or _G.Farmfast or _G.Tweenfruit or _G.Auto_Dungeon or _G.Kill_V4 or _G.AutoQuestRace or _G.RaDaoKhi or _G.Luom_Gear or _G.DaoBiLon or _G.BayDao or _G.Eli_Ngu or _G.Chuate_Bac_Giang or _G.AutoCarvender or _G.Di_nghia_vu_quan_su or _G.AutoEctoplasm or _G.Kiem_Lua or Auto_Ki_Di or _G.Khi_Dot_Len_Dien or _G.AutoPole or _G.Quest_Nhu_Cai_Lon or _G.Katakuri_V2_Nhu_lon or _G.Auto_Nha_Dien or _G.AutoMaterial or _G.Cuttay or _G.Thang_Cha_Up_Muon or Gan_Haki_Lon or _G.HaiCac or _G.Shanda or BatDauKaitun or _TerroSharkVaPirranhaOMG or _G.Zone6 or _G.TeleportPly or _G.RaidPirate or _G.autoLawRaid or StartFarm or FarmMasGun or _G.Chest or _G.Buoi == true then
    ...
    while wait() do
        spawn(
            ...
            or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                Nhamnhangnho:SetDesc("Bot lo spawn")	
            else
                Nhamnhangnho:SetDesc("Dell Co Boss")	
            end
        end
        )
    end
...
local function updateMirageStatus()
    ...
    if mirageIsland then
        DaoNaoCac:SetDesc('Status: Có đảo kìa chó')
    else
...
local Toggle = Tabs.Main:AddToggle("kaitun", { Title = "kaitun 1-2550", Description = "", Default = false })
Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.af:AddToggle("EvoV2", { Title = "Auto Race 2", Default = false })
Toggle:OnChanged(function(Value)
...
local ToggleTPKitsune = Tabs.af:AddToggle("ToggleTPKitsune", {Title = "Tween to kitsune island",Description = "", Default = false })
    ...
    while wait() do
      ...
      local ToggleCollectAzure = Tabs.af:AddToggle("ToggleCollectAzure", {Title = "Collect Azure",Description = "", Default = false })
...
local ToggleTrade = Tabs.af:AddToggle("ToggleTrade", {Title = "Trade azure",Description = "", Default = false })
      ToggleTrade:OnChanged(function(Value)
...
local Dungua = Tabs.st:AddSection("Sea 3")
...
local ToggleRandomFruit = Tabs.item:AddToggle("ToggleCavander", {Title = "Auto Cavander sw",Description = "", Default = false })
ToggleRandomFruit:OnChanged(function(Value)
    _G.AutoCarvender = Value
end)

local CavandisPos = CFrame.new(-12682.096679688, 390.88653564453, -9902.1240234375)
...
local Toggle = Tabs.Raid:AddToggle("Start Raid", { Title = "Làm All for raid", Default = false })
Toggle:OnChanged(function(Value)
    _G.Auto_Buy_Chips_Dungeon = Value
...
local yeuemmotdoi = Tabs.Raid:AddSection("Bác sĩ béo")

local Toggle = Tabs.Raid:AddToggle("Bacsigay", { Title = "Quýnh bỏ mẹ Law", Default = false })
Toggle:OnChanged(function(Value)
...
local Section = Tabs.Misc:AddSection("Misc Cac má mày")
...
Tabs.Misc:AddSection("Cac")

Tabs.Misc:AddButton({
	Title = "Remove Sương mù",
	Description = "",
	Callback = function()
        NoFog()
    end
